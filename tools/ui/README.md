...
**Los botones del pie van sin caja.** Ni el grupo lleva fondo ni el botón encendido: el estado se lee en la tinta —encendido en `--foreground`, apagado en `--fg-3`— y al pasar aparece `--hover`.
