...
// Ahora son TODO lo que hay en `tasks/<slug>/artifacts/`, con la misma etiqueta que tenían.
func TestArtifactsAreEverythingInTheTaskFolder(t *testing.T) {
	...
	for _, name := range []string{"kyc.html", "kyc.dictar-centrales.html", "casos.sql", "que-se-hizo.md", ".DS_Store"} {
