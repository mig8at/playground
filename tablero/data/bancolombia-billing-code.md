...
mismo pedido, las dos preguntas de negocio (¿el `billingCode` es el mismo PIN de Corbeta? ¿quién crea
la orden?). No es código — el detalle en «⏭ SI RETOMÁS, EL PRÓXIMO PASO ES ESTE», más abajo.
