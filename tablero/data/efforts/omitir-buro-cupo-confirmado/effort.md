...
# Confirmación de cupo (omite buró)
(migrado del nodo-tarea `confirmacion-de-cupo` del árbol de context, 2026-07-21)

CUÁNDO APLICA: Cuando la tarea toca el flujo 'Confirmación de cupo' / omitir Experian: el selector que salta el buró vía flow-signature (flow_id=2), las 2 APIs con verdicto en `code`, recortar lenders a rt=0, el contador de consultas por comercio con regla de frecuencia, o la deuda del rechazo de firma que pasa inadvertido.
...
- frontend-monorepo/modules/loan-request-wizard/loan-application-form/src/lib/index.ts
- frontend-monorepo/modules/loan-request-wizard/loan-application-form/src/lib/utils/schemas/phone-number.ts
- legacy-backend/app/Actions/RiskCentrals/Experian.php
- legacy-backend/Modules/RiskV2/App/Services/CheckExperianTriggerService.php
- legacy-backend/Modules/RiskV2/App/Services/CheckIfAbleToOmitService.php
- legacy-backend/Modules/UserRequestV1/App/Constants/Flow.php
- legacy-backend/Modules/UserRequestV1/App/Services/FlowSignatureService.php
- legacy-backend/Modules/UserRequestV1/App/FlowValidators/Flow/AlreadyConfirmedPreApprovalFlowValidator.php
- legacy-backend/Modules/UserRequestV1/App/Repositories/UserRequestRepository.php
- legacy-backend/Modules/Onboarding/App/Http/Controllers/LenderListingController.php
- legacy-backend/Modules/AlliedV1/App/Services/GetExperianQueryCountByAlliedIdService.php
- frontend-monorepo/modules/loan-request-wizard/loan-application-form/src/lib/infrastructure/pre-approval-flow.repository.ts
