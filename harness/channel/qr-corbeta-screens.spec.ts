 ...
 *   · el wizard en :5174 apuntando al backend del target (lo levanta `bin/advisor`/`bin/qr`);
...
test.describe('canal QR — pantallas de autogestión', () => {
    ...
    test.beforeAll(async () => {
        ...
        // corrida — por ejemplo las del runner por API. Mismo mecanismo que usa `bin/advisor` al arrancar.
