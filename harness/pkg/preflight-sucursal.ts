// preflight-sucursal.ts — ¿LA SUCURSAL QUE ANUNCIAMOS ES LA QUE VA A USAR EL WIZARD?
//
...
//      que usa el panel para anunciar (`branchHashForSlug`) y lo que `bin/asesor` le pasa al wizard.
...
//
// ⚠ EL CHEQUEO QUE YA EXISTÍA NO ALCANZA. `bin/asesor` y el panel comparan
