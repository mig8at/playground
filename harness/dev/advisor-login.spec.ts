 ...
 *
 * Orquestado por bin/advisor: arranca el wizard local (:5174) con su `.env` BASE (config dev →
...
test('asesor login (dev)', async ({ browser }) => {
    ...
    // Modo MONTO manual (bin/advisor <merchant>, sin 2º posicional): dejamos el navegador ABIERTO en
