...
description: Probar la entrada por tienda (ecommerce) en el harness frontend-e2e - la URL base64 que serializa el pedido, el contrato con el plugin de WooCommerce/VTEX, y el techo actual del canal. Usala cuando la tarea toque el checkout de un ecommerce, pkg/checkout-b64.ts, bin/ecommerce, mock-redirect (:8096) o las suites channel/ecommerce-*.spec.ts.
---
