...
- **Hardcodes de personas**: 5 celulares personales de staff en `ManualValidationService.php:18-24` y el email `admin.ecommerce@creditop.com` como asesor por defecto hacia los lenders.
...
- **Identidad y roles** — `app/Models/User.php:32-64` (fillable), `app/Models/User.php:147-165` (`getFilteredIds`, el `-t%`), `app/Models/User.php:188-191` (relación muerta a `CorporateUser`), `app/Models/User.php:201-204` (`lender()` = rol Entidad), `app/Models/User.php:219-222` (`generatedUserRequests`), `app/Models/User.php:286-289` (`branches`) · `database/seeders/RolesTableSeeder.php:25-38` · `database/seeders/ModelHasRolesTableSeeder.php:21-28` · migraciones `database/migrations/2014_10_12_000000_create_users_table.php:17-22`, `…create_user_profiles_table.php`, `…create_corporate_users_table.php` (sin `user_id`).
