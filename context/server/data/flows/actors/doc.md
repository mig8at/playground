...
- **Identidad y roles** — `app/Models/User.php:32-64` (fillable), `app/Models/User.php:164-182` (`getFilteredIds`, el `-t%`), `app/Models/User.php:205-208` (relación muerta a `CorporateUser`), `app/Models/User.php:218-221` (`lender()` = rol Entidad), `app/Models/User.php:236-239` (`generatedUserRequests`), `app/Models/User.php:303-306` (`branches`) · `database/seeders/RolesTableSeeder.php:25-38` · `database/seeders/ModelHasRolesTableSeeder.php:21-28` · migraciones `database/migrations/2014_10_12_000000_create_users_table.php:17-22`, `…create_user_profiles_table.php`, `…create_corporate_users_table.php` (sin `user_id`).
