...
## Enlaces
- **CONTEXTOS por group:** architecture (**application** · **legacy-backend** · **frontend-monorepo** · **ms-preapprovals** · **harness**) · entities (**creditopx** · **aggregator** [subctx → **corbeta**] · **redirect** · **credifamilia**) · creditopx (**profiling** · **amount-tiers**) · merchants (**motai** · **smartpay** · **pullman**) · **onboarding** · **formalization** · **servicing** · **ecommerce** · **payments** · **kyc** · **dynamic-forms** · **actors** · **entities** · **merchants** · **architecture**.
