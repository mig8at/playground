...
## Enlaces
- **CONTEXTOS por group:** architecture (**application** · **legacy-backend** · **frontend-monorepo** · **ms-preapprovals**) · entities (**creditopx** · **aggregator** · **redirect** · **credifamilia**) · creditopx (**profiling** · **amount-tiers**) · merchants (**motai** · **smartpay** · **pullman**) · **onboarding** · **formalization** · **servicing** · **kyc** · **dynamic-forms** · **actors** · **entities** · **merchants** · **architecture**.
