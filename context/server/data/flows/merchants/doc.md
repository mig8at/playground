...
- Modelos: `app/Models/Allied.php` · `app/Models/AlliedBranch.php` (`app/Models/Country.php:18` default del trigger, `app/Models/Country.php:79` `isEcommerceBranch`, `app/Models/Country.php:83` `hasCreditopX`) · `app/Models/LendersByAllied.php` · `app/Models/LendersByAlliedBranch.php` · `app/Models/AlliedEcommerceCredential.php` · `app/Models/Country.php:16` (`COLOMBIA_ID = 47`).
