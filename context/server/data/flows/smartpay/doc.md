...
- **Notificaciones / MDM config**: `Modules/Loans/App/Services/NotificationService.php` (mailer smartpay `:55-57`, `sendClientImeiRegisteredNotification:128`, `sendImeiContractNotification:140`), `config/mail.php:90-101` (`noreply@tusmartpay.com`), `config/services.php:517-520` (`merchant_gateways.host`).
