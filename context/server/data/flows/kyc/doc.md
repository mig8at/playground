...
- **Relaciones `User`** (application): `app/Models/User.php:249` (`datacredito()` por NOMBRE + latest) · `app/Models/User.php:261` (`tusDatos`, rc 2) · `app/Models/User.php:267` (`agildata`, 3) · `app/Models/User.php:273` (`mareigua`, 6) · `app/Models/User.php:279` (`aml`, 4) · `app/Models/User.php:285` (`ado`, por nombre `'Ado'`).
