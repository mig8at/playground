...
- `Modules/Onboarding/App/Http/Controllers/OnboardingController.php:39-57` mapa ONB→HTTP · `Modules/Onboarding/App/Http/Controllers/OnboardingController.php:899` (`validateOtpCodeAndRedirect`) · `Modules/Onboarding/App/Http/Controllers/OnboardingController.php:981-1065` **el docblock que describe los 16 pasos y las rarezas congeladas** · `Modules/Onboarding/App/Http/Controllers/OnboardingController.php:1066` orquestador · `Modules/Onboarding/App/Http/Controllers/OnboardingController.php:1188` `createUserRequest` · `Modules/Onboarding/App/Http/Controllers/OnboardingController.php:1235-1256` ONB002 (temporal) · `Modules/Onboarding/App/Http/Controllers/OnboardingController.php:1270-1272` stub aleatorio de pre-aprobación · `Modules/Onboarding/App/Http/Controllers/OnboardingController.php:1290-1319` `userViability` (Experian) · `Modules/Onboarding/App/Http/Controllers/OnboardingController.php:1329-1338` autofill 209/210/211 · `Modules/Onboarding/App/Http/Controllers/OnboardingController.php:1344-1362` ONB004 · `Modules/Onboarding/App/Http/Controllers/OnboardingController.php:1365` `ONB006` con `success: true`.
- `Modules/Onboarding/App/Services/UserRequestService.php:72` (`createUserRequest`) · `Modules/Onboarding/App/Services/UserRequestService.php:73` `findByHash` · `Modules/Onboarding/App/Services/UserRequestService.php:111-138` (`handleRegularRequest`, `amount` en la clave) · `Modules/Onboarding/App/Services/UserRequestService.php:144-199` rama ecommerce · `Modules/Onboarding/App/Services/UserRequestService.php:241-252` estado 9 + `UserRequestRecord` · `Modules/Onboarding/App/Services/UserRequestService.php:287-288` estado 3 (guard `!= 11 && != 25`).
- `Modules/Onboarding/App/Services/OnboardingService.php:107` (`storePersonalInfo`) · `Modules/Onboarding/App/Services/OnboardingService.php:129` `Experian::creditScore` **comentado** bajo un log que dice lo contrario · `Modules/Onboarding/App/Services/OnboardingService.php:132-168` rate limit → ONB040 · `Modules/Onboarding/App/Services/OnboardingService.php:892` (`storeLaboralInformation`) · `Modules/Onboarding/App/Services/OnboardingService.php:1009-1045` field 160 = `'no'` · `Modules/Onboarding/App/Services/OnboardingService.php:1298-1306` `isTemporalUser` / `isUserValidatedWithRiskCentrals` · `Modules/Onboarding/App/Services/OnboardingService.php:1443-1472` config del rate limit · `Modules/Onboarding/App/Services/OnboardingService.php:1474-1483` `isForm1Completed` = [29, 87, 160].
...
- `Modules/Onboarding/App/Services/RegisterCellPhoneService.php:56` (`getRegistrationData`: partner + `partner_modes` + branch + sucursales) · `Modules/Onboarding/App/Services/RegisterCellPhoneService.php:56` (`processCellPhoneRegistration`) · `Modules/Onboarding/App/Services/RegisterCellPhoneService.php:378-386` `createTemporalUser` · `Modules/Onboarding/App/Services/RegisterCellPhoneService.php:474-476` `isTemporaryUser`.
