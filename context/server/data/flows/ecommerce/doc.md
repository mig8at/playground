...
- `Modules/Onboarding/App/Services/UserRequestService.php:105` `findOrCreateUserRequest` (bifurca por credencial) · `:202` `handleEcommerceRequest` (`:209` id de request||session, `:225` puente `UserRequestsByEcommerceRequest`) — **punto de link, frontera con onboarding**.
