...
- `app/Observers/UserRequestObserver.php:26` `STORE_NOTIFY_STATUSES=[6,7,8,11]` · `app/Observers/UserRequestObserver.php:51` `wasChanged` + `notifyStoreForUserRequest`.
...
- `routes/customer.php:242-245` (`checkout/{hash}`, `checkout/process`, `checkout/return`, `checkout/cancelar`; `routes/customer.php:119` `registrar-celular-eccommerce`) · `routes/api.php:156-181` (vtex + ecommerce) · `routes/admin.php:71` `aliados.ecommerce`.
