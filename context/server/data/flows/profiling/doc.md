...
- **Datacrédito-cupo (gate antes de la categoría; mecánica en Motor de decisión)**: `Modules/Loans/App/Services/DatacreditoRuleEvaluator.php` (`Modules/Loans/App/Services/LenderUserCategoryService.php:19` evaluate, bypass CE&&84 `Modules/Loans/App/Services/LenderUserCategoryService.php:21`, sin regla skip→pass `Modules/Loans/App/Services/LenderUserCategoryService.php:25`, fail-closed `Modules/Loans/App/Services/LenderUserCategoryService.php:48`).
