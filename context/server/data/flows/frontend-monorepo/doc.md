...
2. Filtra elegibles (`response_type !== STANDARD`, `available-lenders.tsx:189`) y **lanza una Promise por lender sin await** (`:209`). Los `is_fallback_lender` esperan a que todo el lote primario termine (`:231`). Las 4 variantes Welli **comparten una sola consulta** (`:200-229`).
