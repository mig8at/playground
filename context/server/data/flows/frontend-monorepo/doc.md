...
| `VITE_PREAPPROVALS_ENDPOINT` | **MS Go de pre-aprobaciones** (`POST /v1/preapprovals/check`) | **sólo `process.env`** (server-only) | `available-lenders.tsx:148`, `preapproval-retry.tsx:26` |
