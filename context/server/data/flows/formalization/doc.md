...
- Memorias: `[[migracion-application-a-legacy-estado]]`, `[[continuacion-credito-servicing]]` (el grafo post-11), `[[credifamilia-flujo-mapa]]` (rt=4 / Netco / Deceval), `[[modelos-canales-flujos]]` (SmartPay y agregadores), `[[harness-split-view]]` (la topología A/B que nace del 403 desktop).
