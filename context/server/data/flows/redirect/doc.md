...
- **Frontend** (frontend-monorepo): `modules/loan-request-wizard/lenders-marketplace/src/lib/domain/constants/lender.constants.ts:37` (`LENDER_RESPONSE_TYPE.STANDARD=0`) · `apps/loan-request-wizard/app/routes/lenders-marketplace/available-lenders.tsx:85-105` (estrategia external-redirect/popup) `:150,290` (excluye rt=0 de pre-aprobación) · `apps/loan-request-wizard/app/utils/route-helpers.ts:203` (`redirectExternal`).
