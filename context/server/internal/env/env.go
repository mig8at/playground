...
// manual ganen sobre el .env. (Copiado de playground/tools/internal/env.)
package env
...
// cwd (ej. registrado en Claude Code): así encuentra context/server/.env igual.
...
func LoadDefaults() {
	...
	if exe, err := os.Executable(); err == nil {
		...
		Load(filepath.Join(dir, "..", ".env")) // p.ej. bin/ -> raíz del server
	}
}
