...
### actors — Actors  ·  _reference_ · 75 archivos
...
**Cuándo:** Cuando el prestamista decide AFUERA por API (`response_type` 1): Bancolombia (BNPL 68 / Consumo 100), Welli (23/141/142/166), Meddipay (39), Prami (12), Compensar (47). Pre-aprobación, webhook `lender-result`, cartera del tercero, y por qué no se puede simular en local. ⚠ Addi, Sistecrédito, Banco de Bogotá, Lagobo y Davivienda NO son de acá: son rt=0 (redirect), medido en prod el 2026-09-18. ⚠ El webhook NO registra su recepción: «no llegó» y «llegó y falló» se ven igual desde la BD (F-94), y la única huella es `profiling_reviews.disbursed_lender`.
...
### creditopx — CreditopX  ·  _reference_ · 21 archivos
...
### db-routines — Rutinas de BD  ·  _reference_ · 12 archivos
...
### dynamic-forms — Dynamic Forms  ·  _reference_ · 87 archivos
...
### ecommerce — Ecommerce  ·  _reference_ · 75 archivos
...
### formalization — Formalization  ·  _reference_ · 88 archivos
...
### kyc — KYC  ·  _reference_ · 43 archivos
...
### legacy-backend — legacy-backend  ·  _reference_ · 89 archivos
...
### merchants — Merchants  ·  _reference_ · 63 archivos
...
### motai — Motai  ·  _reference_ · 93 archivos
...
### ms-preapprovals — MS Pre-approvals  ·  _reference_ · 78 archivos
...
### onboarding — Onboarding  ·  _reference_ · 99 archivos
...
### payments — Payments  ·  _reference_ · 77 archivos
...
### profiling — Profiling  ·  _reference_ · 31 archivos
...
### redirect — Redirect  ·  _reference_ · 31 archivos
...
### rotativo — Rotativo (rt=3)  ·  _flujo_ · 15 archivos
...
### servicing — Servicing  ·  _reference_ · 90 archivos
...
### smartpay — SmartPay  ·  _reference_ · 86 archivos
