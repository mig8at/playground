// ═══ ARCHIVO DE REFERENCIA · fuera de la UI, pero VIVO ═══
//
// Acá vive la hoja paramétrica COMPLETA (19 fórmulas, 17 inputs) con las 6 configuraciones de
// producto. No la usa la app: la app quedó en lo mínimo (monto + cuotas + tasa) para poder ir
// creciendo de a poco y sin ruido.
//
// Pero `verify.mjs` SÍ la corre, así que la prueba sigue en pie: **una hoja reproduce los
// cuatro productos, 30 puntos de control exactos** contra los .xlsm y el PDF. Borrar esto
// sería borrar la evidencia de que la estandarización es correcta.
//
// Cómo volver a crecer: docs/HOJA-COMPLETA.md tiene el orden sugerido, un bloque por vez.
